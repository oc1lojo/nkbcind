nkbc32 <- list(
  ...
  om_indikatorn = "Vid HER2-positiv invasiv bröstcancer rekommenderas antikroppsbehandling i kombination med cytostatika, under förutsättning att patienten kan tolerera det sistnämnda.",
